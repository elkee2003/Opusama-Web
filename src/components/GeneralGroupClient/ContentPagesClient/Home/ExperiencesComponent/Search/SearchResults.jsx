  ...
  return (
    ...
    >
      <div 
        ...
        onClick={() => navigate(`/clientcontent/experience_detailedpost/${post.id}`)}>
        {mediaUris.length > 0 ? (
          mediaUris[0].type === 'video' ? (
            <div className='pVideoWrapper'>
              ...
              <div 
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  navigate(`/clientcontent/experience_detailedpost/${post.id}`);
                }}
              />
            </div>
          ) : (
      ...
      {/* Bed & Bedrooms */}
      {post?.packageType && <p className='searchBedroom'>Beds: {post?.packageType}</p>}
