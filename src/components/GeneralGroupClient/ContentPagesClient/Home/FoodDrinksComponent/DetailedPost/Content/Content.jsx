...
function Content({post, realtor,}) {
    ...
    const {selectedOption, setSelectedOption, setPostPrice, postPrice, setPostCautionFee, setPostOtherFeesName, setPostOtherFeesPrice, setPostOtherFeesName2, setPostOtherFeesPrice2, setPostTotalPrice} = useBookingShowingContext();
