...
function Post({post}) {
    ...
    const handleNavigate = (postId) => {
      ...
      navigate(`/clientcontent/food_drinks_detailedpost/${postId}`);
    };
  ...
  return (
    <div className='singlePostContainer'>
            ...
            mediaUris[0].type === 'video' ? (
              <div className='pVideoWrapper'>
                ...
                <div 
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    navigate(`/clientcontent/food_drinks_detailedpost/${post.id}`);
                  }}
                />
              </div>
            ) : (
        ...
        <div 
          ...
          onClick={()=>navigate(`/clientcontent/food_drinks_detailedpost/${post.id}`)}
        >
          {/* Username */}
          <div 
              className={'contact'}
