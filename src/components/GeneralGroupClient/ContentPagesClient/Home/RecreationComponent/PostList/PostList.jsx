    ...
    <div className='postListContainer' >
        ...
        <div>
            <button 
                ...
                onClick={()=>navigate(`/clientcontent/search_recreation`)}
            >
                <FontAwesomeIcon icon={faSearch} size="2x" />
                <span className="homeSearchBtnTxt">Search for Recreation</span>
            </button>
        </div>
        ...
        {realtorPosts && realtorPosts.length > 0 ? (
            ...
            <div className='noListngsCon'>
                <p className="noListings">No Recreation listings</p>
            </div>
        )}
        {refreshing && (
