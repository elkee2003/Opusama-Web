...
import AccommodationDropDown from '../EditDropDown/AccommodationDropDown/Accommodation';
import CountryDropDown from '../EditDropDown/CountryDropDown/CountryDropDown';
import PropertySale from '../EditDropDown/PropertySale/PropertySale';
import Recreation from '../EditDropDown/Recreation/Recreation';
import NightLife from '../EditDropDown/NightLife/NightLife';
import BookingPostOption from './BookingPostOption';
import WriteDescription from '../EditDropDown/Desription/Description';
import OfficeSpace from '../EditDropDown/OfficeSpace/OfficeSpace';
import CommercialSpace from '../EditDropDown/CommercialSpace/CommercialSpace';
import EventType from '../EditDropDown/EventType/EventType';
import FoodDrinks from '../EditDropDown/FoodDrinks/FoodDrink';
import Venue from '../EditDropDown/Venue/Venue';
...
const Forms = () => {
  ...
  const goToReview = () => {
    if (onValidate()) {
      navigate('/realtorcontent/edit_uploaded_post');
    }
  };
