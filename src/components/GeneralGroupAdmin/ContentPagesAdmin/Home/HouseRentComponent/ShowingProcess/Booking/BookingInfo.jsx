...
import Booking from './BookingDetails/Booking';
...
// Each post has many fields, and some of them are:
...
// In Booking, this is it- before this component was used solely for hotel/shorlet, but now I want to use it for all, so the date chosen, for categories that don't need checkout, instead of 'date', use only the checkin, also you could change the calendar if you have a better option:
// import React, { useState, useEffect } from 'react';
