  ...
  return (
    <div className="alertContainer">
      <div
        className="alertCard"
        onClick={() =>
          navigate(`/admin/total_bookings_details/${notification.id}`)
        }
      >
        {/* Subscription */}
        ...
        {/* Overall Price */}
        {notification.overAllPrice && (
          <p className="alertDetails">
            <span className="alertDetailsSub">OverAll Amount:</span> ₦
        ...
        {/* Service Charge */}
        <p className="alertDetails">
          <span className="alertDetailsSub">Service Charge:</span> ₦
          {Number(notification.serviceCharge).toLocaleString()}
        </p>

        {/* Opusama Commission */}
        <p className="alertDetails">
          <span className="alertDetailsSub">Opusama Commission:</span> ₦
        ...
        {notification.realtorPrice && (
          <p className="alertDetails">
            <span className="alertDetailsSub">Vendor Amount:</span> ₦
