...
const BookingSingle = ({ booking, onDelete, onUpdateStatus }) => {
  ...
  return (
    <div className="bookingSingleContainer">
      ...
      {booking.post ? (
        <div onClick={() => navigate(`/admin/bookingdetails/${booking.id}`)}>
          ...
          <div onClick={(e) => {
            ...
            navigate(`/admin/exploredetailedpost/${booking.PostID}`);
            }}>
            <h4
        ...
        <div>
          <h4 className="subHeading">Accommodation Type:</h4>
          <p className="detail" style={{ color: 'gray', fontStyle: 'italic' }}>
