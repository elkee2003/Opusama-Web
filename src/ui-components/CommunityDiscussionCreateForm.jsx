...
export default function CommunityDiscussionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setInstigatorID(initialValues.instigatorID);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CommunityDiscussion(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CommunityDiscussionCreateForm")}
      {...rest}
    >
      <TextField
        label="Category"
