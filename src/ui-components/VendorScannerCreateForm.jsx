...
export default function VendorScannerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new VendorScanner(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "VendorScannerCreateForm")}
      {...rest}
    >
      <TextField
        label="Vendor id"
