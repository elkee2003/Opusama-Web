...
const BookingShowingContextProvider = ({children}) => {
    ...
    const [opusamaCommission, setOpusamaCommission] = useState(0);
    ...
    // reset the states after booking
